...
//
//  Created by dengtao on 2017/5/17.
...
@interface ViewController ()<SlidingSegmentControlDelegate,PunchScrollViewDelegate,PunchScrollViewDataSource,UIScrollViewDelegate>
...
-(UIView *)oneView{
    ...
    if (_oneView == nil) {
        ...
        _oneView = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_scrollView.frame), kScreenWidth,kScreenHeight -  CGRectGetMaxY(_slidingSegControl.frame))];
...
-(UIView *)twoView{
    ...
    if (_twoView == nil) {
        ...
        _twoView = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_scrollView.frame), kScreenWidth,kScreenHeight -  CGRectGetMaxY(_slidingSegControl.frame))];
...
-(UIView *)threeView{
    ...
    if (_threeView == nil) {
        ...
        _threeView = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_scrollView.frame), kScreenWidth,kScreenHeight -  CGRectGetMaxY(_slidingSegControl.frame))];
